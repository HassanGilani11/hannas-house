...
$first_post = $next_post ? $next_post : get_posts(array('numberposts' => 1))[0];

if ($first_post) {
    if (!empty($option['next-post-text'])) {
        $nextText = '<h5 class="nav-subtitle">' . esc_html__($option['next-post-text'], 'alioth') . '</h5> <h3 class="nav-title">' . esc_html($first_post->post_title) . '</h3>';
    } else {
        $nextText = '<h5 class="nav-subtitle">' . esc_html__('Next Post:', 'alioth') . '</h5> <h2 class="nav-title">' . esc_html($first_post->post_title) . '</h2>';
    }
    ?>
    ...
    <nav class="navigation post-navigation" aria-label="Posts">
        <div class="nav-links">
            <div class="nav-next">
                <a href="<?php echo get_the_permalink($first_post); ?>" rel="next">
                    <?php echo $nextText; ?>
                </a>
            </div>
        </div>
